const STORE_ID = "noodles";
const STORE_NAME = "給個麵子傳統麵店";
...
function renderCart() {
  if (!state.cart.length) {
    elements.cartItems.innerHTML = `<div class="empty-state">購物車目前是空的，先去挑幾樣想吃的吧。</div>`;
  } else {
